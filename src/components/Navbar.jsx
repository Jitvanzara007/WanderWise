  ...
  return (
    <nav className="bg-white shadow-lg fixed w-full z-50">
      <div className="flex justify-between items-center h-20 px-4">
        ...
        {/* Auth Buttons - End (Home page, not authenticated) */}
        {isHomePage && !user && !isAuthPage ? (
          ...
          <>
            ...
            <div className="hidden md:flex items-center space-x-4 pe-6">
              {user ? (
                <>
                  <Link
                    to="/profile"
            ...
            {user && !isAuthPage && (
              <>
                <Link
                  ...
                  className={`block px-4 py-2.5 text-base font-semibold rounded-lg transition-all duration-300 ${
                    location.pathname === '/explore' 
            ...
            {user ? (
              <>
                <Link
                  to="/profile"
                  onClick={handleNavigation}
                  className="block px-4 py-2.5 text-base font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-lg transition-all duration-300"
                >
                  <div className="flex items-center">
                    <FiUser className="w-4 h-4 mr-2" />
                    My Profile
                ...
                <button
                  onClick={handleLogout}
                  className="block w-full text-left px-4 py-2.5 text-base font-semibold text-blue-600 bg-white border-2 border-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-300"
                >
                  <div className="flex items-center">
                    <FiLogOut className="w-4 h-4 mr-2" />
                    Sign Out
              ...
              <>
                <Link
                  to="/login"
                  onClick={handleNavigation}
                  className="block px-4 py-2.5 text-base font-semibold text-gray-700 hover:text-blue-600 hover:bg-gray-50 rounded-lg transition-all duration-300"
                >
                  Sign In
                </Link>
                <Link
